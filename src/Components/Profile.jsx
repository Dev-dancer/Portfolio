...
export const Profile = () => {
  return (
    ...
    <div id="large-display-classes" className='lg:grid lg:grid-cols-2 '>
     <div className="flex flex-row p-4 mb-8 m-4 bg-slate-200 rounded-xl md:justify-center lg:items-center lg:flex-col xl:flex-row">

    <img className=" lg:mr-8 w-32 h-32 rounded-full border-4 border-white  outline-blue-400 outline md:w-40 md:h-40 lg:w-72 lg:h-72 lg:outline-none lg:rounded-xl lg:border-none" src="/placeholder image.png" alt="" />
