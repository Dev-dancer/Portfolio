...
export const Profile = () => {
  return (
    ...
    <div id="large-display-classes" className='lg:grid lg:grid-cols-2 '>
     <div className="flex flex-row p-4 mb-2 m-4 bg-slate-200 rounded-xl md:justify-center lg:items-center lg:flex-col xl:flex-row ">

    <img className=" lg:mr-8 w-32 h-32 rounded-full border-4 border-white  outline-blue-400 outline md:w-40 md:h-40 lg:w-72 lg:h-72 md:mr-10 lg:outline-none lg:rounded-xl lg:border-none" src="/placeholder image.png" alt="" />
    ...
    <div className=" hidden flex-row justify-evenly lg:justify-normal lg:flex xl:flex-wrap" id="Resume">
      <a href='C:\Users\devan\OneDrive\Desktop\DOCS\resume.pdf' download='Devansh_Resume'>
        <button className='bg-violet-500 justify-center  flex flex-row items-center gap-1  p-4 m-2 lg:ml-0 borderradius font-medium hover:bg-violet-400 transition ease-in rounded-lg shadow-lg shadow-violet-500/50  md:p-6 md:w-52 '><p className='text-xl text-white'> Resume&nbsp;</p> <FontAwesomeIcon style={{color:'white'}} icon={faDownload} className='size-5'></FontAwesomeIcon>   </button></a>
    ...
    <div id="about" >
      ...
      <h1 className='mt-6 text-transparent bg-clip-text bg-gradient-to-r to-slate-700 from-slate-500 text-3xl w-fit font-extrabold border-b-4 ml-4 border-slate-700 md:mt-2 md:text-4xl'>ABOUT</h1>

        <p className='m-4 mt-2  font-medium text-lg tracking-tighter text-justify  ' >Hello! I'm an enthusiastic code and web developer with a passion for creating dynamic, user-friendly websites and applications. My journey in the world of coding began with a curiosity for how things work behind the scenes, and it has since evolved into a full-fledged career that I love.
          Birthday:
1 May 1995
Website:
www.example.com
...
Available 
        ...
        <p className='m-4 mt-2  font-medium text-lg tracking-tighter text-justify  ' >I am currently looking for new job opportunities where I can leverage my skills and passion for web development. I am eager to join a dynamic team and contribute to exciting projects. If you are looking for a dedicated and innovative web developer, I would love to connect and discuss how I can be a valuable addition to your team.</p>
    </div>
