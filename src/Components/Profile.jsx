...
export const Profile = () => {
  return (
    ...
    <img className="w-32 h-32 rounded-full border-4 border-white  outline-blue-400 outline md:w-40 md:h-40 lg:w-72 lg:h-72 lg:outline-none lg:rounded-xl lg:border-none" src="/placeholder image.png" alt="" />
